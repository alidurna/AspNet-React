/**
 * Tasks Header Component - Yeni Tasarım
 * 
 * Tasks sayfasının header kısmını yöneten component.
 */

import React from 'react';
import { FaPlus, FaSearch, FaTh, FaList, FaColumns, FaFilter } from 'react-icons/fa';
...
/**
 * TasksHeader Component - Yeni Tasarım
 */
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-200"
          />
        </div>
